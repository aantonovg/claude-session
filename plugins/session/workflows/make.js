...
const side = stem => `${DIR}/make-${stem}.md`
const F = {
  spec: side('spec'), scenarios: side('scenarios'), tests: side('tests'), code: side('changed'),
  run: side('run'), control: side('control-run'), coverage: side('coverage'), check: side('spec-check'),
}
