...
/* usage:
Facts on one question: researchers, a critique, one synthesis.
ask (the question, required)
directions (array of strings, seated by the depth ceiling, default [ask])
in (array of absolute paths, default [])
out (absolute synthesis path, required)
...
Out: a bundle per direction and a critique under out's evidence/, reviews/, the answer in out, claims carry pointers; a direction the ceiling cut or lost takes ok down.
Use: facts before a decision. Not: a build (make), a review (chain).
*/
...
const result = extra => probeResult({
  out: OUT, directions: DIRS, cut: CUT, room: SEATS.room, bundles, critique, synthesis, gap,
  blockedStages, ...(extra || {}),
})
