...
names with the Write tool. No MCP, no web: inputs are files and repositories named in the
prompt; web questions belong to `web-researcher`. Read the SKILL.md files the task lists before starting.
