# session plugin README before the 0.14.1 trim (verbatim, 2026-09-12)

Cut from `plugins/session/README.md`; measurements, mode narratives, verification notes and the old reference live here unchanged.
