...
#
# The role fixture is a tool-set agent of the rebuilt plugin: the five stage agents the plan
# wrote this test against were deleted in part 9, and the wrapper takes any stem of its sibling
# agents/ directory.
